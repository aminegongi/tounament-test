        ...
        <div className="navbarV1">
          <div className="navbarV1__container">
            <div className="navbarV1__container__menu">
              <a
                href="#introduction"
                className="navbarV1__container__menu__text"
              >
                LE CLUB
              </a>
              <a href="#staff" className="navbarV1__container__menu__text">
                STAFF
              </a>
              <a href="#prices" className="navbarV1__container__menu__text">
                TARIFS
              </a>
              <a href="#contact" className="navbarV1__container__menu__text">
                CONTACT
              </a>
            </div>
            ...
            <div className="navbarV1__container__contact">
              <div className="navbarV1__container__contact__text">
                {data.contact.body.phoneNumber1}{' '}
                {!isEmpty(data.contact.body.phoneNumber1) &&
                  `/ ${data.contact.body.phoneNumber1}`}
              </div>
              <Link href="#contact">
                <a>
                  <button
                    onClick={() => {}}
                    className="navbarV1__container__contact__join_button"
                  >
          ...
          <div className="navbarV1">
            ...
            <BurgerMenu.slide
              ...
              customBurgerIcon={
                !isMenuOpen ? (
                  ...
                  <Icon className="buttonclose" type="close" />
                )
              }
            ...
            >
              ...
              >
                ...
                >
                  <a href="#introduction" style={{ color: 'black' }}>
                    LE CLUB
                  </a>
                </div>
                <div
                  ...
                  className="navbar__menutext"
                >
                  <a href="#staff" style={{ color: 'black' }}>
                    STAFF
                  </a>
                </div>
                <div

    ...
    <div className={css.recommandation}>
      ...
      <div className={css.recommendation__rate}>
        <Radio.Group onChange={onChange} >
          <Radio value={4} className={css.radio}></Radio><Rate disabled defaultValue={4} className={css.rate} /> <span className={css.recommendation__rate__plus}>et plus</span> <br />

          <Radio value={3}></Radio><Rate disabled defaultValue={3} className={css.rate} /> <span className={css.recommendation__rate__plus}>et plus</span> <br />

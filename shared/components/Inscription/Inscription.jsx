...
const Inscription = ({ isModalVisible, setIsModalVisible }) => {
  ...
  return (
    <>
      ...
      >
        <div className="inscription__title">Créer un compte</div>
        <div className="inscription__input">
          ...
          <div className="inscription__input__inscrit">
            ...
            <div className="inscription__input__inscrit__message">
              Votre numéro va être envoyé à l'entraîneur pour valider votre
              cours..
            </div>
          </div>
          <div className="inscription__input__inscrit">
        ...
        <div className="inscription__signup">
          ...
          <div className="inscription__signup__contact">Connectez-vous</div>
        </div>
      </Modal>
    </>
  )
